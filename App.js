...
function App() {
  ...
  const showNotificationPermissionDialog = () => {
    // Prompt the user to go to the app's settings to enable notification permissions
  ...
  useEffect(() => {
    ...
    // Permissions.request(Permissions.NOTIFICATIONS).then((result) => {
  ...
  const onRegister = async (token) => {
    console.log(
      " setupNotification ==> @@@ FCM Registeration Token ==========",
      token
    );
  };
