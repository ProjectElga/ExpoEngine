    ...
    messaging().onNotificationOpenedApp((remoteMessage) => {
      ...
      if (remoteMessage) {
        ...
        if (!remoteMessage.data) {
          ...
          updatedNotification = remoteMessage;
          updatedNotification["isBackground"] = true;
          onOpenNotification(updatedNotification);
          return;
        }
        ...
        updatedNotification["isBackground"] = true;
        onOpenNotification(
          Platform.OS === "ios" ? remoteMessage.data.item : updatedNotification
        );
